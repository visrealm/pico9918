...
firmwareMenu: PROCEDURE
    ...
    PRINT AT XY(2, MENU_TOP_ROW + 0), "Current version :  v"
    PRINT AT XY(2, MENU_TOP_ROW + 1), "New version     :  v",FIRMWARE_MAJOR_VER,".",FIRMWARE_MINOR_VER
    ...
    PRINT AT XY(22, MENU_TOP_ROW + 0), verMaj, ".", verMin
    ...
    IF isUpgrade = 0 THEN
        PRINT AT XY(2, MENU_TOP_ROW + 5), "Re-install firmware"
    ELSEIF isUpgrade = 1 THEN
        PRINT AT XY(2, MENU_TOP_ROW + 5), "Upgrade firmware to"
    ELSE
        PRINT AT XY(2, MENU_TOP_ROW + 5), "Downgrade firmware to"
    END IF
