        ...
        ELSE
            FOR BL = 1 TO FIRMWARE_BLOCKS_PER_BANK
                ...
                FOR #UF2OFFSET = 0 TO 8
                    IF bank2Data(#FWOFFSET + #UF2OFFSET) <> uf2Header(#UF2OFFSET) THEN
                        blockFailed = TRUE
                ...
                #UF2BLOCK = bank2Data(#FWOFFSET + 20) + (bank2Data(#FWOFFSET + 21) * 256)
                ...
                FOR #UF2OFFSET = #FIRMWARE_BLOCK_BYTES - 4 TO #FIRMWARE_BLOCK_BYTES - 1
                    IF bank2Data(#FWOFFSET + #UF2OFFSET) <> uf2Header(#UF2OFFSET - 256) THEN
                        blockFailed = TRUE
