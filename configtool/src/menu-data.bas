...
configMenuData:
    ...
    DATA BYTE PICO9918_CONF_CRT_SCANLINES,    "CRT scanlines   ", OPT_OFFSET_ONOFF,   OPT_COUNT_ONOFF,   "    Faux CRT scanline effect    "
    DATA BYTE PICO9918_CONF_SCANLINE_SPRITES, "Scanline sprites", OPT_OFFSET_SPRITES, OPT_COUNT_SPRITES, "                                "
    DATA BYTE PICO9918_CONF_CLOCK_PRESET_ID,  "Clock frequency ", OPT_OFFSET_CLOCK,   OPT_COUNT_CLOCK,   "  MCU clock  (requires reboot)  "
    ...
    DATA BYTE PICO9918_CONF_DIAG_REGISTERS,   "Registers       ", OPT_OFFSET_ONOFF,   OPT_COUNT_ONOFF,   "      Show VDP registers        "
    DATA BYTE PICO9918_CONF_DIAG_PERFORMANCE, "Performance     ", OPT_OFFSET_ONOFF,   OPT_COUNT_ONOFF,   "     Show performance data      "
    DATA BYTE PICO9918_CONF_DIAG_ADDRESS,     "Addresses       ", OPT_OFFSET_ONOFF,   OPT_COUNT_ONOFF,   "      Show VRAM addresses       "
    DATA BYTE PICO9918_CONF_DIAG_PALETTE,     "Palette         ", OPT_OFFSET_ONOFF,   OPT_COUNT_ONOFF,   "         Show palettes          "
    DATA BYTE CONF_MENU_CANCEL,      "<<< Main menu   ", 0,                  0,                 "        Back to main menu       "
    ...
    DATA BYTE PICO9918_CONF_DISP_DRIVER_PREF, "Driver          ", OPT_OFFSET_DRIVER,     OPT_COUNT_DRIVER,     "Output driver (requires reboot) "
    DATA BYTE PICO9918_CONF_VGA_MODE,         "VGA/HDMI mode   ", OPT_OFFSET_VGA_MODE,   OPT_COUNT_VGA_MODE,   "  VGA mode  (requires reboot)   "
    DATA BYTE PICO9918_CONF_SCART_MODE,       "SCART mode      ", OPT_OFFSET_SCART_MODE, OPT_COUNT_SCART_MODE, " SCART mode  (requires reboot)  "
    DATA BYTE CONF_MENU_CANCEL,      "<<< Main menu   ", 0,                     0,                    "        Back to main menu       "
...
configMenuOptionValueData:
    ...
    ' SCART mode - OPT_OFFSET_SCART_MODE, OPT_COUNT_SCART_MODE  (matches PICO9918_CONF_SCART_MODE: 0=PAL, 1=NTSC)
    DATA BYTE "576i50"
    DATA BYTE "480i60"
