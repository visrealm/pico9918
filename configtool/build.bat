...
python tools\uf2cvb.py -b 8 -o src\firmware_8k pico9918-vga-build-v1-2-diag.uf2
python tools\uf2cvb.py -b 16 -o src\firmware_16k pico9918-vga-build-v1-2-diag.uf2
